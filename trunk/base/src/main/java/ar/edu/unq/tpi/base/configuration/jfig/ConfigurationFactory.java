package ar.edu.unq.tpi.base.configuration.jfig;
...
import ar.edu.unq.tpi.base.persistence.SoftDeleteManager;
...
public class ConfigurationFactory {
    ...
    public AnnotationConfiguration buildConfiguration(final String name, final Properties properties) {
        ...
        properties.setProperty("hibernate.search.default.indexBase", FrameworkConfiguration.getWorkingDirectoryFile().getAbsolutePath() + File.separator + "lucene-db");
